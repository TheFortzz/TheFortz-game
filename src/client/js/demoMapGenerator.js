    ...
    function createDemoMaps() {
        try {
            ...
            if (maps.length === 0) {
                ...
                const demoMaps = [
                    {
                        id: 'demo_desert_arena',
                        name: 'Desert Arena',
                        creator: 'DemoCreator',
                        vehicleType: 'tank',
                        isUserCreated: true,
                        description: 'A sandy battlefield with scattered rocks and obstacles. Perfect for tank combat.',
                        groundTiles: generateDesertTiles(),
                        objects: generateDesertObjects(),
                        createdAt: Date.now()
                    },
                    {
                        id: 'demo_forest_maze',
                        ...
                        vehicleType: 'tank',
                        isUserCreated: true,
                        description: 'Navigate through dense forest paths with trees and natural barriers.',
                        groundTiles: generateForestTiles(),
                        objects: generateForestObjects(),
                        createdAt: Date.now() - 1000
                    },
                    {
                        id: 'demo_lava_pit',
                        name: 'Lava Pit',
                        creator: 'VolcanoBuilder',
                        vehicleType: 'tank',
                        isUserCreated: true,
                        description: 'Dangerous volcanic terrain with lava flows and rocky outcrops.',
                        groundTiles: generateLavaTiles(),
                        objects: generateLavaObjects(),
